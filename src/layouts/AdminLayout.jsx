...
export const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { label: "Disputes Desk", path: "/admin/disputes", icon: AlertTriangle },
    { label: "System Payments", path: "/admin/payments", icon: CreditCard },
    { label: "System Settings", path: "/admin/settings", icon: Settings },
  ];

  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white flex transition-colors duration-205">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white dark:bg-gray-900 border-r border-gray-150 dark:border-gray-850 h-screen sticky top-0">
        <div className="p-6 border-b border-gray-150 dark:border-gray-850 flex items-center justify-between">
          <Link to="/admin/dashboard" className="flex items-center gap-2">
            <div className="bg-red-650 p-2 rounded-xl text-white shadow-md bg-rose-600">
              <Sparkles className="w-5 h-5" />
            </div>
            <span className="text-lg font-bold tracking-tight text-gray-950 dark:text-white">
              Gig<span className="text-rose-600">Admin</span>
            </span>
          </Link>
        </div>
            ...
            >
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-150 dark:border-gray-800">
                <Link to="/admin/dashboard" className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-bold text-gray-950 dark:text-white">GigAdmin</span>
                </Link>
                <button
                  onClick={() => setIsSidebarOpen(false)}
                  ...
                  <>
                    ...
                    >
                      <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
                        <span className="text-xs font-bold text-gray-855 dark:text-white">System Events</span>
                        {unreadCount > 0 && (
                          <button
                          ...
                          notifications.map((n) => (
                            <div
                              ...
                              className={`px-4 py-3 border-b border-gray-50 dark:border-gray-850 last:border-0 hover:bg-gray-50 dark:hover:bg-gray-850 cursor-pointer transition-colors ${
                                !n.read ? "bg-rose-50/20 dark:bg-rose-950/10" : ""
                              }`}
                            >
            ...
            <div className="relative">
              ...
              >
                <img
                  src={user.avatar}
                  alt={user.name}
                  className="w-8 h-8 rounded-lg object-cover border border-gray-150 dark:border-gray-800"
                />
                  ...
                  <>
                    ...
                    >
                      <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-800">
                        ...
                        <p className="text-[10px] text-gray-405">{user.email}</p>
                      </div>
