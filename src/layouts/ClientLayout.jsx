...
export const ClientLayout = () => {
  ...
  const navItems = [
    ...
    { label: "Projects", path: "/client/projects", icon: FileCode },
    { label: "Contracts", path: "/client/contracts", icon: FileSpreadsheet },
    { label: "Payments", path: "/client/payments", icon: Wallet },
    { label: "Messages", path: "/client/chat", icon: MessageSquare },
    { label: "Profile & Settings", path: "/client/settings", icon: Settings },
  ];
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden sm:block text-left pr-2">
                  ...
                  <p className="text-[10px] text-gray-400 font-medium">Workspace Client</p>
                </div>
              </button>
